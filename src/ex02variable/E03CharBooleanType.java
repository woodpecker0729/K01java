...
public class E03CharBooleanType {
	...
	public static void main(String[] args) {
		/*
		 * char형 : 하나의 문자를 저장할 수 있는 자료형으로 값을 저장할 때 '(single quotation)로 감싸서 표현한다. 만약
		 * "(double quotation)로 감싸면 문자열로 인식하므로 String형으로 선언해야 한다.
		 */
		char ch1 = '가';
		...
		/*
		 * boolean형 : true 혹은 false 두가지의 값만 가질 수 있는 자료형으로 산술연산(+,- 등)이나 비교연산 (<, >= 등)에는
		 * 사용할 수 없다. 단, 논리연산은 가능하다.
		 */
		boolean bn1 = true;
		boolean bn2 = false;
		System.out.println("bn1=" + bn1 + ", bn2=" + bn2);
		/*
		 && : 논리And 연산으로 양쪽 모드 참일 때 참을 반환한다. 나머지는 거짓을 반환한다.
		 || : 논리Or 연산으로 둘 중 하나만 참이면 참을 반환한다. 둘 다 거짓일때만 거짓을 반환한다.
		 */
		boolean bn3 = bn1 && bn2;
